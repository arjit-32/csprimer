...
<Notice type="note">Let's try to summarize all the laws in a single image.</Notice>

![boolean-algebra-laws](https://res.cloudinary.com/dwa6rcttw/image/upload/v1779679492/laws-of-boolean-algebra_qxbsi6.webp)
